...
public class Pa2U1P4CbDbApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// se puede usar el LocalDateTime o LocalDate
		...
		// Buscarpor Cedula
		Estudiante estuC1 = this.estudianteService.buscarPorCedula("1720030723");
		System.out.println("La Cedula buscada" + "\nPertence al  " + estuC1);
		Estudiante estuC2 = this.estudianteService.buscarPorCedula("12131212");
		System.out.println("El estudiante no está registrado  " + estuC2);
	}
}
